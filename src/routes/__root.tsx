...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "InterviewAI Pro — AI-Powered Interview Simulator" },
      { name: "description", content: "Practice real interviews with an AI interviewer. Get detailed performance reports, analytics, and improve with every session." },
      { property: "og:title", content: "InterviewAI Pro" },
      { property: "og:description", content: "AI-powered interview simulator for students and professionals." },
